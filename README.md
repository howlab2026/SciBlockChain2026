# ⚡ SciBlockChain 2026 — 과학제전 블록체인 결제 시뮬레이터 v2.0

> **과학전람회 및 과학제전 행사용 교육용 블록체인 부스 결제 & 암호화폐 시뮬레이션 플랫폼**
...
**SciBlockChain**은 학생 및 일반 관람객이 가상 카드 결제로 행사용 코인을 충전하고, 체험 부스에서 QR 코드로 결제하는 전체 과정을 실시간 암호학 원장으로 시뮬레이션하고 체험할 수 있는 웹 기반 교육용 블록체인 애플리케이션입니다.
...
- 💳 **가상 카드 결제 (PG 모사)**: 카드 결제를 통해 관람객 지갑 잔액 충전 시뮬레이션
