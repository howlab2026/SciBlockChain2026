      ...
      <div style={{ maxWidth: '1000px', width: '100%', display: 'flex', flexDirection: 'column', gap: '40px', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
          <div style={{
            ...
            borderRadius: '24px', fontSize: '16px', color: '#4338ca', fontWeight: '800',
            boxShadow: '0 2px 10px rgba(99,102,241,0.1)'
          }}>
            <Zap size={18} color="#4f46e5" /> 과학제전 블록체인 포털시스템 v2.0
          </div>
          ...
          <p style={{ fontSize: '15px', color: '#475569', maxWidth: '100%', whiteSpace: 'nowrap', lineHeight: 1.6, fontWeight: '500' }}>
            체험 부스 결제, 카드 충전, 암호학 원장 검증 및 거래 분석을 실시간으로 체험할 수 있는 블록체인 플랫폼입니다.
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: '24px' }}>
          ...
          <div className="glass-card" style={{
            padding: '36px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: '24px',
            border: '1px solid #bfdbfe',
            boxShadow: '0 8px 24px rgba(147,197,253,0.15)',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', zIndex: 1 }}>
              ...
              <div>
                <span style={{ fontSize: '14px', textTransform: 'uppercase', letterSpacing: '1px', color: '#4338ca', fontWeight: '800' }}>일반 관람객 모드</span>
              ...
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '12px', color: '#334155', marginTop: '4px' }}>
          ...
          <div className="glass-card" style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', zIndex: 1 }}>
              ...
              <div>
                <span style={{ fontSize: '14px', textTransform: 'uppercase', letterSpacing: '1px', color: '#7e22ce', fontWeight: '800' }}>관리자 승인 모드</span>
                <h3 style={{ fontSize: '24px', fontWeight: '800', color: '#0f172a', marginTop: '4px' }}>
                  시스템 관리자 모드
                </h3>
              </div>
        ...
        <div className="glass-card" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              <div style={{ fontSize: '11px', color: '#64748b', fontWeight: '600' }}>현재 발행 블록</div>
              <div style={{ fontSize: '15px', fontWeight: '800', color: '#0f172a' }}>{bc.chain.length} 개</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Coins size={20} color="#d97706" />
            <div>
              <div style={{ fontSize: '11px', color: '#64748b', fontWeight: '600' }}>활성 토큰</div>
              <div style={{ fontSize: '15px', fontWeight: '800', color: '#0f172a' }}>{bc.coinName}</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <Activity size={20} color="#0d9488" />
            <div>
              <div style={{ fontSize: '11px', color: '#64748b', fontWeight: '600' }}>총 거래 건수</div>
              <div style={{ fontSize: '15px', fontWeight: '800', color: '#0f172a' }}>{stats.totalTxCount} 건</div>
            </div>
          </div>
        </div>
      </div>
