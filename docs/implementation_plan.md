...
- **Styling**: Vanilla CSS3 + Soft Pastel Glassmorphism Design System
...
└── components/
    ...
    ├── WalletTab.tsx            # [1] 관람객 지갑 & 카드 충전 & 송금
...
### 3.1 관람객 & 부스 체험 모드 (General User View)
- 진입 시 4개 핵심 탭 제공: `[관람객 지갑]`, `[체험 부스]`, `[블록 탐색기]`, `[분석 대시보드]`
- 토큰 민팅, 작업증명 난이도 변경, 원장 초기화 등 민감한 제어 메뉴는 차단됨.
