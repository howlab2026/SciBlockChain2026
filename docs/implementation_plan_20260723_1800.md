# 과학제전 블록체인 결제 실습 시스템 (SciBlockChain v2.0) 종합 아키텍처 및 구현 사양서

## 📌 1. 프로젝트 개요
**SciBlockChain v2.0**은 과학전람회 및 과학제전 행사에서 관람객이 가상 카드 결제로 행사용 암호화폐를 충전하고, 각 체험 부스에서 QR 코드로 결제하는 과정을 실시간으로 체험할 수 있는 교육용 블록체인 결제 체험 플랫폼입니다.
